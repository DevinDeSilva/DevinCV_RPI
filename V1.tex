...
\item \textbf{National Volunteering Platform - Backend Developer}\hfill \href{https://drive.google.com/file/d/1_by4Vxbjj341oY0Xyv1FldULncdpaRPX/view?usp=sharing}{Certificate}

Development of a meeting platform for volunteering organizations and eager volunteers of Sri Lanka.

\textit{Technology}:- Node.js, PostgreSQL, Springboot
\item \textbf{Search Engine for Sinhala Metaphors and associated dataset}\hfill \href{https://github.com/DevinDeSilva/MetaphoreRecommendationSystem}{Github}
\hspace{2mm}
\href{https://www.kaggle.com/datasets/devindesilva1710/sinhala-song-metaphors}{Kaggle}

\textit{Technology}:- ElasticSearch, NLTK, Fast-API
\end{rSection} 
...
\vspace{-1.25em}
\item \textbf{Vice Chairperson of ACM students Chapter, University of Moratuwa}\hfill 2021-2022\\
