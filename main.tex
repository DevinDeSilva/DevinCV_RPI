...
\href{https://research.ibm.com/labs/yorktown-heights}{Thomas J. Watson Research Center - IBM} \hfill \textit{Yorktown Heights, NY}
 \begin{itemize}
    \itemsep -3pt {} 
     \item \textbf{DiagnosticIQ} - A Dataset for Benchmarking Decision-Making by LLMs on Industrial Maintenance from faults to fixes.
     \item Maintenance Recommendation engine
 \end{itemize}
...
\vspace{-1.25em}
\item \textbf{\href{https://github.com/DevinDeSilva/LLM-Workflow-Explorer}{Explainability and Traceability of AI Systems through
Provenance Tagging}}\\
\textit{\textbf{XAI+KG @ ISWC 2026}}\\
Developed a provenance-based explainability system for AI workflows by representing execution traces as a semantic knowledge graph. Implemented a neuro-symbolic question answering pipeline that retrieves workflow evidence and synthesizes grounded explanations.

\textit{Technology}:- Dspy, Ontologies, Agent Systems 

\item \textbf{\href{https://arxiv.org/abs/2605.08614}{DiagnosticIQ: A Benchmark for LLM-Based Industrial Maintenance Action Recommendation}}\\ 
\textit{\textbf{NeurIPS 2026 E\&D Track}} \\
Built a dataset generation and benchmarking pipeline for industrial maintenance recommendations using LLMs and temporal sensor rules. Created a 6,000+ MCQA dataset and evaluated multiple LLMs across several dimensions for maintenance recommendation and model fine-tuning.

\textit{Technology}:- python  

\item \textbf{\href{https://arxiv.org/abs/2507.00050}{SEZ-HARN: Self-Explainable Zero-shot HAR Network}} \hfill \textit{Computers and Electrical Engineering Journal}
\item \textbf{\href{https://link.springer.com/chapter/10.1007/978-981-99-8184-7_34}{TEZARNet: TEmporal Zero-Shot Activity Recognition Network}} \hfill \textit{ICONIP 2024}
\item \textbf{\href{https://arxiv.org/abs/2411.10273}{Fill in the blanks: Rethinking Interpretability in vision}} \hfill \textit{arXiv preprint}
\item \textbf{\href{https://arxiv.org/abs/2302.03873}{Geometric Perception-Based Efficient Text Recognition}} \hfill \textit{SSRN Electronic Journal}
...
%----------------------------------------------------------------------------------------
\begin{rSection}{Competitions and Hackathons} 
